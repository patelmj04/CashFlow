...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b border-gray-800 bg-black/100 backdrop-blur supports-[backdrop-filter]:bg-black/60">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link href="patelmj04" className="text-gray-400 hover:text-white">
              ...
              <Link href="https://x.com/patelmj04" className="text-gray-400 hover:text-white">
              ...
              <Link href="https://www.instagram.com/its_mit_btw/" className="text-gray-400 hover:text-white">
              ...
              <Link href="https://www.linkedin.com/in/patelmj04/" className="text-gray-400 hover:text-white">
