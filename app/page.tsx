...
<header className="sticky top-0 z-50 w-full border-b bg-black/50 backdrop-blur supports-[backdrop-filter]:bg-black/60">
  <div className="container flex h-16 items-center justify-between">
    ...
    <div className="flex items-center gap-4">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-x-4">
                ...
                <Link href="#features">
                  <Button size="lg" variant="outline" className=" hover:bg-white/10 text-black">
                    Learn More
                  </Button>
                </Link>
              </div>
      ...
      <footer className="w-full border-t bg-black py-6 md:py-12">
  <div className="container px-4 md:px-6">
    ...
    <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
      <p className="text-xs text-gray-400">© 2025 ExpenseTracker. All rights reserved.</p>
